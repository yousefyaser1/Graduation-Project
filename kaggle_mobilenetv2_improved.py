...
PHASE1_MODEL = "/kaggle/working/sixth_code_mobilenetv2_phase1.keras"
OUTPUT_MODEL = "/kaggle/working/sixth_code_mobilenetv2_improved_model.keras"
...
# ---------------------------------------------------------------------------
# 1. Load raw datasets (unbatched for oversampling)
# ---------------------------------------------------------------------------
...
non_tinea_count = int(counts.sum()) - tinea_count
...
steps_per_epoch = target_total // BATCH_SIZE
